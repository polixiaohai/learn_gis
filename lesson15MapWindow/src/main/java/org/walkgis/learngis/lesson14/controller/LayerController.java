...
import org.walkgis.learngis.lesson14.basicclasses.GISDocument;
...
public class LayerController implements Initializable {
    ...
    @FXML
    private Button btnMoveUp, btnMoveDown, btnOpenAttr, btnAddLayer, btnDeleteLayer, btnExportLayer;
    @FXML
