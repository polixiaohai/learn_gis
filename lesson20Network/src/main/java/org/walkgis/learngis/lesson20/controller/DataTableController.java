...
import org.walkgis.learngis.lesson20.basicclasses.GISFeature;
import org.walkgis.learngis.lesson20.basicclasses.GISLayer;
import org.walkgis.learngis.lesson20.basicclasses.GISVectorLayer;
...
public class DataTableController implements Initializable {
    ...
    public void initTable(GISVectorLayer layer) {
        fromMapWindow = true;
