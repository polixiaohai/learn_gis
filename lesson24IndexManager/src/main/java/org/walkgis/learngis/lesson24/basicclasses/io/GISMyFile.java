package org.walkgis.learngis.lesson24.basicclasses.io;
...
public class GISMyFile {
    public static class MyFileHeader {
        ...
        public void read(DataInputStream input) throws IOException {
            ...
            this.hasTree = input.readBoolean();
        }
    }
    ...
    public static void writeFileMultiLayers(List<GISVectorLayer> layers, String fileName) {
        ...
        try {
            ...
            for (GISVectorLayer layer : layers) {
                ...
                if (layer.rTree != null) layer.rTree.writeFile(dataOut);
            }
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        } catch (IOException e) {
        ...
        try {
            ...
            do {
                ...
                if (mfh.hasTree) {
                    ...
                    layer.rTree.readFile(dataInput);
                }
                layers.add(layer);
