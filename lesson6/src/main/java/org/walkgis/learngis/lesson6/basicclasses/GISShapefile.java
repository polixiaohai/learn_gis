...
import org.walkgis.learngis.lesson6.Utils;
        ...
        try {
            ...
            while (br.available() > 0) {
                ...
                if (ShapeType == SHAPETYPE.point) {
                    ...
                    lines.forEach(line -> {
                        GISFeature onefeature = new GISFeature(line, new GISAttribute());
                    ...
                    polygons.forEach(polygon -> {
                        GISFeature onefeature = new GISFeature(polygon, new GISAttribute());
